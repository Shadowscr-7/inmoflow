...
/* â”€â”€â”€ Sticky WhatsApp button â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
    ...
    <main className="relative bg-[#060d1a] text-white overflow-x-clip">
      ...
      <section className="relative flex flex-col items-center text-center px-6 pt-20 pb-24 overflow-hidden">
        ...
        >
          ...
          Sistema de gestiÃ³n para inmobiliarias
        </div>
        <h1
        ...
        >
          RespondÃ© en segundos, automatizÃ¡ el seguimiento y cerrÃ¡ mÃ¡s propiedades
        ...
        >
          {[
            "Nunca mÃ¡s perdÃ¡s un lead por no responder a tiempo",
            "Seguimiento automÃ¡tico que convierte interesados en clientes",
        ...
        <p className="text-sm text-gray-600">Sin tarjeta. ConfiguraciÃ³n guiada. Resultados desde el dÃ­a 1.</p>
      </section>

      {/* â”€â”€â”€ PROBLEMA â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      <section className="px-6 sm:px-12 py-20 max-w-5xl mx-auto">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold mb-4">Hoy tu inmobiliaria funciona asÃ­ âŒ</h2>
          <p className="text-gray-400 text-lg">Y cada lead perdido = dinero perdido.</p>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {[
            { emoji: "ðŸ“±", text: "Leads perdidos de Meta Ads que nadie responde a tiempo" },
            { emoji: "ðŸ’¬", text: "WhatsApp desordenado con conversaciones mezcladas" },
            { emoji: "ðŸ“‹", text: "Seguimiento manual que nunca se hace bien" },
            { emoji: "ðŸ¥¶", text: "Clientes que 'quedan en veremos' y nunca cierran" },
            { emoji: "â³", text: "Oportunidades que se enfrÃ­an mientras estÃ¡s ocupado" },
            { emoji: "ðŸ’¸", text: "InvertÃ­s en publicidad y no convertÃ­s lo suficiente" },
          ].map(({ emoji, text }) => (
        ...
        <div className="mt-10 p-6 rounded-2xl bg-gradient-to-r from-red-950/40 to-orange-950/20 border border-red-500/15 text-center">
          <p className="text-xl font-bold text-white">EstÃ¡s generando leadsâ€¦ pero no estÃ¡s convirtiendo lo suficiente.</p>
        </div>
      </section>

      {/* â”€â”€â”€ TRANSFORMACIÃ“N â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      <section className="px-6 sm:px-12 py-20 max-w-5xl mx-auto">
        <div className="text-center mb-12">
          <p className="text-xs font-bold text-emerald-400 uppercase tracking-widest mb-3">La soluciÃ³n</p>
          <h2 className="text-3xl sm:text-4xl font-extrabold mb-4">Con InmoFlow âœ…</h2>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 mb-10">
          {[
            { icon: Inbox, label: "Cada lead entra automÃ¡ticamente al sistema" },
            { icon: Zap, label: "Se responde en segundos, sin intervenciÃ³n manual" },
            { icon: MessageSquare, label: "Se sigue de forma automÃ¡tica sin que lo pienses" },
            { icon: Calendar, label: "Se agenda la visita sin fricciÃ³n" },
      ...
      {/* â”€â”€â”€ ANTES VS DESPUÃ‰S â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      <section className="px-6 sm:px-12 py-20">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-extrabold">Antes vs. DespuÃ©s</h2>
          </div>
          <div className="grid grid-cols-2 gap-4">
            <div className="p-6 rounded-2xl bg-red-950/20 border border-red-500/15">
              <p className="text-sm font-bold text-red-400 uppercase tracking-wider mb-5">âŒ Antes</p>
            ...
            <div className="p-6 rounded-2xl bg-emerald-950/20 border border-emerald-500/15">
              <p className="text-sm font-bold text-emerald-400 uppercase tracking-wider mb-5">âœ… DespuÃ©s</p>
              <ul className="space-y-3">
      ...
      {/* â”€â”€â”€ CÃ“MO FUNCIONA â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      <section className="px-6 sm:px-12 py-20 max-w-5xl mx-auto">
        <div className="text-center mb-14">
          <p className="text-xs font-bold text-blue-400 uppercase tracking-widest mb-3">Proceso</p>
          <h2 className="text-3xl sm:text-4xl font-extrabold">CÃ³mo funciona</h2>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            { num: "01", color: "text-blue-400", bg: "bg-blue-600/15 border-blue-500/15", icon: Inbox, title: "Captura automÃ¡tica", desc: "Meta Ads, WhatsApp, Telegram, Web, MercadoLibre. Todo entra solo.", tag: "Sin perder nada" },
            { num: "02", color: "text-emerald-400", bg: "bg-emerald-600/15 border-emerald-500/15", icon: Bot, title: "Respuesta inmediata", desc: "IA responde en segundos como si fueras vos. Primer contacto = clave de conversiÃ³n.", tag: "En segundos" },
            { num: "03", color: "text-amber-400", bg: "bg-amber-600/15 border-amber-500/15", icon: MessageSquare, title: "Seguimiento automÃ¡tico", desc: "Mensajes, recordatorios, reactivaciÃ³n. Nunca mÃ¡s se enfrÃ­a un cliente.", tag: "Sin esfuerzo" },
            { num: "04", color: "text-purple-400", bg: "bg-purple-600/15 border-purple-500/15", icon: Target, title: "Cierre", desc: "Agenda, visitas, pipeline y mÃ©tricas. MÃ¡s operaciones, menos esfuerzo.", tag: "MÃ¡s cierres" },
      ...
      {/* â”€â”€â”€ IA â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      <section className="px-6 sm:px-12 py-20">
        <div className="max-w-4xl mx-auto rounded-3xl bg-gradient-to-br from-blue-950/60 via-purple-950/40 to-[#060d1a] border border-blue-500/20 p-10 sm:p-14 text-center relative overflow-hidden">
          ...
          <div className="relative">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              Mientras vos trabajÃ¡sâ€¦ o dormÃ­sâ€¦ el sistema sigue vendiendo por vos.
            </p>
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 max-w-2xl mx-auto">
              {[
                { icon: MessageSquare, label: "Responde consultas automÃ¡ticamente" },
                { icon: Target, label: "Califica leads en tiempo real" },
                { icon: Users, label: "Mantiene conversaciÃ³n real" },
      ...
      {/* â”€â”€â”€ RESULTADOS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      <section className="px-6 sm:px-12 py-20 max-w-5xl mx-auto">
        <div className="text-center mb-14">
          <p className="text-xs font-bold text-emerald-400 uppercase tracking-widest mb-3">Resultados</p>
          <h2 className="text-3xl sm:text-4xl font-extrabold mb-4">Lo que cambia cuando implementÃ¡s InmoFlow</h2>
          <p className="text-gray-400 text-lg max-w-xl mx-auto">
            No necesitÃ¡s mÃ¡s leads. NecesitÃ¡s{" "}
            <span className="text-white font-semibold">convertir mejor los que ya tenÃ©s.</span>
          </p>
        </div>
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-5">
          {[
            ...
            { icon: TrendingUp, metric: "+40%", label: "Tasa de conversiÃ³n", bg: "bg-blue-600/15 border-blue-500/15", color: "text-blue-400" },
      ...
      {/* â”€â”€â”€ ROI â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      <section className="px-6 sm:px-12 py-20">
        <div className="max-w-3xl mx-auto text-center">
          <div className="p-10 rounded-3xl bg-gradient-to-br from-emerald-950/50 to-[#060d1a] border border-emerald-500/20">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold mb-8">Hagamos nÃºmeros simples</h2>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-10">
              {[
                { label: "ComisiÃ³n promedio", value: "USD 2.000" },
            ...
            <p className="text-xl font-bold text-gray-200">
              ...
              <span className="text-emerald-400">una sola operaciÃ³n mÃ¡s</span>â€¦ ya se pagÃ³ solo.
            </p>
            <p className="text-sm text-gray-500 mt-3">Todo lo demÃ¡s es ganancia pura.</p>
          </div>
        </div>
      </section>
      ...
      <section className="px-6 sm:px-12 py-20 max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {[
            ...
            { icon: Bot, title: "Agente IA", desc: "Respuestas automÃ¡ticas que convierten. ChatGPT, Gemini, Claude integrado.", bg: "bg-purple-600/15 border-purple-500/15", color: "text-purple-400" },
            ...
            { icon: TrendingUp, title: "MÃ©tricas en tiempo real", desc: "SabÃ©s quÃ© funciona y quÃ© no. Dashboard con reportes de comisiones.", bg: "bg-rose-600/15 border-rose-500/15", color: "text-rose-400" },
      ...
      {/* â”€â”€â”€ PARA QUIÃ‰N ES â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      <section className="px-6 sm:px-12 py-20">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-extrabold">Â¿Es para vos?</h2>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="p-8 rounded-2xl bg-emerald-950/20 border border-emerald-500/15">
              <p className="text-sm font-bold text-emerald-400 uppercase tracking-wider mb-6 flex items-center gap-2">
                <Check className="w-4 h-4" /> InmoFlow es para vos siâ€¦
              </p>
              <ul className="space-y-4">
                {[
                  "GenerÃ¡s leads pero no convertÃ­s lo suficiente",
                  "TenÃ©s mÃ¡s de un canal de contacto",
                  "PerdÃ©s oportunidades por falta de seguimiento",
                  "QuerÃ©s escalar sin contratar mÃ¡s gente",
                ].map((t) => (
            ...
            <div className="p-8 rounded-2xl bg-red-950/15 border border-red-500/10">
              <p className="text-sm font-bold text-red-400 uppercase tracking-wider mb-6 flex items-center gap-2">
                <X className="w-4 h-4" /> NO es para vos siâ€¦
              </p>
              <ul className="space-y-4">
                {[
                  "No generÃ¡s leads de ningÃºn canal",
                  "No querÃ©s automatizar nada",
                  "PreferÃ­s seguir todo de forma manual",
                ].map((t) => (
      ...
      <section id="pricing" className="px-6 sm:px-12 py-20 scroll-mt-16">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-14">
            ...
            <p className="text-gray-400 text-lg">Todo incluido. Sin contratos. CancelÃ¡s cuando querÃ©s.</p>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="relative rounded-2xl border-2 border-emerald-500/50 bg-emerald-950/15 p-8 flex flex-col shadow-[0_0_60px_-12px_rgba(16,185,129,0.2)]">
              ...
              <div className="mt-3 mb-4">
                <h3 className="text-xl font-bold text-white mb-1">Prueba gratis 15 dÃ­as</h3>
                <p className="text-sm text-emerald-300/70">EmpezÃ¡ sin pagar nada. Luego $750/mes.</p>
              </div>
              <div className="mb-4">
                <div className="flex items-end gap-2">
                  <span className="text-6xl font-extrabold text-white">$0</span>
                  <div className="pb-2">
                    <p className="text-xs text-emerald-400 font-semibold">por 15 dÃ­as</p>
              ...
              <div className="mb-6 p-3 rounded-xl bg-emerald-950/60 border border-emerald-500/20">
                <p className="text-xs text-center text-emerald-400/70 mb-2">Esta oferta estÃ¡ disponible por tiempo limitado</p>
                <CountdownTimer />
              </div>
            ...
            <div className="relative rounded-2xl border border-white/[0.1] bg-white/[0.03] p-8 flex flex-col hover:border-white/[0.18] transition-all duration-300">
              ...
              <div className="mb-8">
                ...
                <p className="text-xs text-gray-500 mt-2">Sin contratos Â· CancelÃ¡s cuando querÃ©s</p>
              </div>
              <ul className="space-y-2.5 mb-8 flex-1">
                {[
                  "Todos los canales (WhatsApp, Meta, Telegram, Email)",
          ...
          <p className="text-center text-xs text-gray-600 mt-8">
            Todos los planes incluyen actualizaciones. Sin contratos. PodÃ©s cancelar en cualquier momento.
          </p>
        </div>
      </section>

      {/* â”€â”€â”€ CTA FINAL â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      <section className="px-6 sm:px-12 py-20">
        <div className="max-w-3xl mx-auto text-center">
          <div className="p-10 sm:p-14 rounded-3xl bg-gradient-to-br from-[#0f1f12] via-emerald-950/20 to-[#060d1a] border border-emerald-500/20 relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <h2 className="text-3xl sm:text-5xl font-extrabold mb-4">No pierdas mÃ¡s oportunidades</h2>
              <p className="text-xl text-gray-300 mb-2">Cada lead que no respondÃ©s a tiempoâ€¦</p>
              ...
              <p className="text-sm text-gray-600 mt-6">Sin tarjeta. Sin burocracia. ConfiguraciÃ³n en minutos.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm text-gray-600">
              Â© {new Date().getFullYear()} InmoFlow â€” El sistema que convierte leads en ventas.
            </span>
          </div>
