    ...
    <main className="relative bg-[#060d1a] text-white overflow-x-clip">
      ...
      <nav className="sticky top-0 z-40 flex items-center justify-between px-6 sm:px-12 py-4
        ...
        <div className="flex items-center gap-3">
          ...
          <a href="#pricing" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg text-sm font-bold
      ...
      <section className="relative flex flex-col items-center text-center px-6 pt-20 pb-24 overflow-hidden">
        ...
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-emerald-500/10 border border-emerald-500/20 mb-8 text-sm font-medium text-emerald-300"
          style={{ animation: mounted ? "fadeIn 0.5s ease-out" : "none" }}>
          <Rocket className="w-4 h-4" />
          Sistema de gestión para inmobiliarias
        </div>
        <h1 className="text-4xl sm:text-6xl lg:text-7xl font-extrabold tracking-tight leading-tight max-w-4xl mb-6"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-left max-w-xl w-full mb-10"
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-5"
          ...
          <a href="https://wa.me/5491100000000?text=Hola%2C%20quiero%20agendar%20una%20demo%20de%20InmoFlow"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 mb-10">
          {[
            ...
            <div key={label} className="relative flex flex-col items-center text-center p-5 rounded-xl bg-emerald-950/20 border border-emerald-500/15 gap-3">
              <div className="absolute -top-3 left-1/2 -translate-x-1/2 w-6 h-6 rounded-full bg-emerald-600 text-white text-xs font-bold flex items-center justify-center">{i + 1}</div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="relative rounded-2xl border-2 border-emerald-500/50 bg-emerald-950/15 p-8 flex flex-col
              ...
              <a href="https://wa.me/5491100000000?text=Hola%2C%20quiero%20empezar%20la%20prueba%20gratuita%20de%2015%20d%C3%ADas%20de%20InmoFlow"
                target="_blank" rel="noopener noreferrer"
            ...
            <div className="relative rounded-2xl border border-white/[0.1] bg-white/[0.03] p-8 flex flex-col
              ...
              <a href="https://wa.me/5491100000000?text=Hola%2C%20quiero%20contratar%20el%20plan%20Profesional%20de%20InmoFlow"
                target="_blank" rel="noopener noreferrer"
                className="block w-full text-center px-6 py-4 rounded-xl text-sm font-bold
          ...
          <div className="p-10 sm:p-14 rounded-3xl bg-gradient-to-br from-[#0f1f12] via-emerald-950/20 to-[#060d1a] border border-emerald-500/20 relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="https://wa.me/5491100000000?text=Hola%2C%20quiero%20empezar%20la%20prueba%20gratuita%20de%20InmoFlow"
                  target="_blank" rel="noopener noreferrer"
                  className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl text-base font-bold
                             bg-gradient-to-r from-emerald-600 to-emerald-500 text-white
                             hover:from-emerald-500 hover:to-emerald-400 shadow-xl shadow-emerald-600/30
                ...
                <a href="https://wa.me/5491100000000?text=Hola%2C%20quiero%20agendar%20una%20demo%20personalizada%20de%20InmoFlow"
                  target="_blank" rel="noopener noreferrer"
                  className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl text-base font-semibold
                             text-gray-300 bg-white/[0.05] border border-white/[0.1]
                             hover:bg-white/[0.1] hover:text-white transition-all duration-300">
